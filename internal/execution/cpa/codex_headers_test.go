...
func TestCodexGatewayRequestIdentity(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantUA:  defaultUA, wantOriginator: "codex-tui", wantVersion: "0.155.0",
		},
		{
			...
			wantUA:  defaultUA, wantOriginator: "configured-client", wantVersion: "0.155.0",
		},
		{
		...
		},
		{
			...
			wantUA:  defaultUA, wantVersion: "0.155.0",
		},
		{
		...
		},
		{
			...
			wantUA:  defaultUA, wantOriginator: "codex-tui", wantVersion: "0.155.0", wantSession: "client-session",
		},
		{
			name:    "hyphen session wins over alias",
			headers: http.Header{"Session_id": {"alias-session"}, "Session-Id": {"canonical-session"}},
			wantUA:  defaultUA, wantOriginator: "codex-tui", wantVersion: "0.155.0", wantSession: "canonical-session",
		},
		{
			name:    "blank canonical session falls back to alias",
			headers: http.Header{"Session-Id": {"  "}, "Session_id": {" alias-session "}},
			wantUA:  defaultUA, wantOriginator: "codex-tui", wantVersion: "0.155.0", wantSession: "alias-session",
		},
		{
			name: "prompt cache remains the session fallback", promptCacheKey: "cache-session",
			wantUA: defaultUA, wantOriginator: "codex-tui", wantVersion: "0.155.0", wantSession: "cache-session",
		},
		{
