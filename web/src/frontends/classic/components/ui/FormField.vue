...
.form-field :deep(input:not([data-input-inner], [type='checkbox'], [type='radio'])),
...
.form-field :deep(input:not([data-input-inner], [type='checkbox'], [type='radio'])::placeholder),
.form-field :deep(textarea::placeholder) {
  color: var(--color-text-faint);
  opacity: 1;
}

.form-field--compact :deep(input:not([data-input-inner], [type='checkbox'], [type='radio'])) {
...
.form-field :deep(input:not([data-input-inner], [type='checkbox'], [type='radio']):disabled),
